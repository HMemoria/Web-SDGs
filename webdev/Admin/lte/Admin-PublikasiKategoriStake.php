...
<head>
    ...
    <title>Admin-KategoriStake</title>
      ...
      <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                  Publikasi
                  <small>Daftar Kategori Stakeholder</small>
                </h1>
                      <section class="content container-fluid" >
                        <!--------------------------
                          ...
                          <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              <a href="Admin-AturKategoriStake.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                            </div>
                          <div class="box">
                              <div class="box-header">
                                <h3>Daftar Kategori Stakeholder</h3>
                              </div> 
                              <!-- /.box-header -->
                              <div class="box-body">
                  ...
                  <tr>
                    ...
                    <td><a href="deletekategoristake.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
									</tr>
                  <?php 
                  }
                  } 
