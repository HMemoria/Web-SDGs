                        ...
                        <!--------------------------
                          ...
                          <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              <ul class="sidebar-menu" data-widget="tree">
                                ...
                                <!-- Optionally, you can add icons to the links -->
                                <li><a href="http://localhost/webdev/Admin/lte/Admin-UnggahFoto.php"><i class="fa fa-link"></i> <span>Galeri Foto</span></a></li>
                                <li><a href="http://localhost/webdev/Admin/lte/Admin-UnggahVideo.php"><i class="fa fa-link"></i> <span>Galeri Video</span></a></li>
                                <li><a href="http://localhost/webdev/Admin/lte/Admin-DaftarDokumen.php"><i class="fa fa-link"></i> <span>Dokumen TPB</span></a></li>
                                <li><a href="http://localhost/webdev/Admin/lte/Admin-AturData.php"><i class="fa fa-link"></i> <span>Data TPB</span></a></li>  
                            </ul>
                        </div>
                      </section>
                  </div>
