              ...
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Data Riset dan Lainnya</a></h3>
                          <form action="ScriptFileUploadData.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                              <label for="name_input">Judul</label>
                                <input type="text" class="form-control" id="name_input" name="judul" placeholder="Judul Data">
                         </div>
                          <div class="form-group">
                              <label for="name_input">Tentang</label>
                              <input type="text" class="form-control" id="name_input" name="tentang" placeholder="Data memuat tentang">
                          </div>
                          <div class="form-group">
                            ...
                            <div class="input-group date">
                              ...
                              <input type="text" class="form-control pull-right" id="datepicker" name="tahun">
                            </div>
                            <!-- /.input group -->
                          </div>
                          <div class="form-group">
