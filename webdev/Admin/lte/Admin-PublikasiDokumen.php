                      ...
                      <section class="content container-fluid">
                        <!--------------------------
                          ...
                          <div class="box">
                              ...
                              <a href="Admin-AturDokumen.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                          </div>
                              <!-- /.box-header -->
                          ...
                          <td><a href="deletedokumen.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
