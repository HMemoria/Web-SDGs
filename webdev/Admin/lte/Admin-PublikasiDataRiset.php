                        ...
                        <!--------------------------
                          ...
                          <div class="box box-primary" style="padding : 20px;border-color: #f39d12;height: 140px;">
                           <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              <a href="http://localhost/webdev/Admin/lte/Admin-AturData.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                           </div>
                          <div class="box">
