...
<head>
  ...
  <title>Admin-PublikasiStakeholder</title>
                      ...
                      <section class="content container-fluid" >
                        <!--------------------------
                          ...
                          <div class="box">
                              ...
                              <a href="Admin-AturStakeholders.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                             </div>
                              <!-- /.box-header -->
                                  ...
                                  <thead style="background-color: #f39d12;color: #ffffff;">>
									...
									?>
												...
												<tr>
													...
													<td><?php echo $row['biper']; ?></td>
													<td><?php echo $row['namaperusahaan']; ?></td>
													<td><?php echo $row['tempat']; ?></td>
													<td><?php echo $row['tanggal']; ?></td>
													<td><?php echo $row['peran']; ?></td>
													<td><?php echo $row['notelpon']; ?></td>
													<td><?php echo $row['endmail']; ?></td>
                          <td><a href="deletestake.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
													<?php 
											}
										} 
									?>
