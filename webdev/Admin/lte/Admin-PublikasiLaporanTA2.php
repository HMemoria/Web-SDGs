                      ...
                      <section class="content container-fluid">
                        <!--------------------------
                         ...
                         <div class="box">
                              ...
                              <a href="Admin-LaporanBulanan.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                           </div>
                         </div>
                              <!-- /.box-header -->
                          ...
                          <td><a href="deletelaporanbln.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
										  	</tr>
									<?php 
											}
										} 
